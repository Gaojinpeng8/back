window.onload = function () {
    ...
    // container.style.width = img.offsetWidth + "vw";
    // container.style.height = img.offsetHeight + "vw";
    // container.style.overflow = "hidden";

    //给banner 设置宽高
    banner.style.height = img.offsetHeight + "vw";
    banner.style.width = img.offsetWidth * li.length + "vw";
    banner.style.left = "-80vw";
